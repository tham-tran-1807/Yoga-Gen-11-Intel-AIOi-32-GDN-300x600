...
lib.ssMetadata = [
		{name:"Yoga_Gen_11_Intel_AIOi_32_GDN_300x600_atlas_1", frames: [[1798,0,50,50],[0,0,300,600],[1194,0,300,471],[0,602,296,361],[1496,441,300,386],[1194,473,300,385],[302,0,300,600],[604,0,300,600],[298,602,300,347],[1496,0,300,439],[906,0,286,564]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Yoga_Gen_11_Intel_AIOi_32_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.YogaGen11IntelAIOi32GDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(0,134);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(249).to({_off:false},0).to({_off:true},50).wait(91));
	...
	this.instance_5.setTransform(0,117);
	...
	this.instance_6.setTransform(0,135);
	...
	this.instance_7.setTransform(4,134);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(49).to({_off:false},0).to({_off:true},51).wait(290));

	// F1
	this.instance_8 = new lib.F1();
	this.instance_8.setTransform(0,129);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},49).wait(341));
...
// library properties:
lib.properties = {
	id: 'AF1333F902A2EF4BBE27E3CAF1DF3CA1',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Yoga_Gen_11_Intel_AIOi_32_GDN_300x600_atlas_1.png", id:"Yoga_Gen_11_Intel_AIOi_32_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['AF1333F902A2EF4BBE27E3CAF1DF3CA1'] = {
